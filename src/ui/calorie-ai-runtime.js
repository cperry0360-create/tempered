...
/**
 * Presentation-only bridge for photo calorie estimation.
 *
 * Tempered never sends a photo to an AI service and never embeds an API key.
 * The user copies a provider-neutral prompt, attaches the photo in the AI app
 * of their choice, copies the one-line result, then pastes it back. The paste
 * helper feeds the existing Calories editor so canonical logging/XP rules stay
 * in one place.
 */
export function installCalorieAiRuntime(context) {
